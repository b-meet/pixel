                  ...
                  {isServicesOpen && (
                    ...
                    >
                      <div className="space-y-6">
                        ...
                        <Link href="/tattoo-categories" className="text-[#F5BB47] font-medium text-sm flex items-center gap-2 hover:bg-[#f8f9fa] w-full pt-2 rounded transition-colors group">
                          <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /> More services
                        </Link>
                      </div>
                    </motion.div>
                  )}
            ...
            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
              <div className="p-6">
                ...
                >
                  ...
                  <ChevronUp className={cn("w-5 h-5 text-[#70757a] transition-transform duration-300", !isInsightsOpen && "rotate-180")} />
                </button>
                <AnimatePresence>
                  {isInsightsOpen && (
                    <motion.div
